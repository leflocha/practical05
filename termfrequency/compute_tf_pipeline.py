...
if __name__ == "__main__":
    # string_data = read_file(sys.argv[1])
    # string_data = filter_chars_and_normalize(string_data)
    # words_list = scan(string_data)
    # words_list = remove_stop_words(words_list)
    # words_freq = frequencies(words_list)
    # words_freqs = sort(words_freq)

    # for tf in words_freqs[0:25]:
    #     print(tf[0], "-", tf[1])
    main()
